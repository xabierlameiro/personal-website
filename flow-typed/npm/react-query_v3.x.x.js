// flow-typed signature: 794dffc822a4ca9dfed75dfd8aa77872
// flow-typed version: 88862c5121/react-query_v3.x.x/flow_>=v0.104.x
...
declare module 'react-query' {
    ...
    declare export type QueryCacheListener = (
    ...
    declare export class QueryClient {
        ...
        defaultQueryObserverOptions<
            T: QueryObserverOptions<any, any, any, any>
        >(
            options?: T
        ): T;
    ...
    // updater
    declare export type DataUpdateFunction<TInput, TOutput> = (
        input: TInput
    ) => TOutput
    ...
    declare export type SetStateAction<
        TData = mixed,
        TError = mixed,
        TVariables = mixed,
        TContext = mixed
    ...
    declare export type FetchOptions = {|
        ...
        meta?: mixed,
    |}
    declare export type FetchContext<
        TQueryFnData = mixed,
        TError = mixed,
        TData = TQueryFnData
    > = {|
        ...
        state: QueryState<TData, TError>,
    |}
    declare export type QueryBehavior<
        TQueryFnData = mixed,
        TError = mixed,
        TData = TQueryFnData
    > = {|
    ...
    declare export type QueryFunctionContext<
        TQueryKey = QueryKey,
    ...
    |}
    declare export type QueryFunction<
        TQueryFnData,
        TQueryKey = QueryKey,
        TPageParam = PageParam
    > = (
    ...
    declare export type GetPreviousPageParamFunction<
        TQueryFnData = mixed,
        U = mixed
    > = (firstPage: TQueryFnData, allPages: TQueryFnData[]) => U
    declare export type GetNextPageParamFunction<
        TQueryFnData = mixed,
        U = mixed
    > = (lastPage: TQueryFnData, allPages: TQueryFnData[]) => U
    ...
    |}
    declare export type FetchQueryOptions<
        TQueryFnData = mixed,
        TError = mixed,
        TData = TQueryFnData
    > = {|
    ...
    declare export type InfiniteQueryObserverOptions<
        TQueryFnData = mixed,
        TError = mixed,
        TData = TQueryFnData,
        TQueryData = TQueryFnData
    ...
    declare export type QueryObserverLoadingResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...QueryObserverBaseResult<TData, TError>,
    ...
    declare export type QueryObserverLoadingErrorResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...QueryObserverBaseResult<TData, TError>,
    ...
    declare export type QueryObserverRefetchErrorResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...QueryObserverBaseResult<TData, TError>,
    ...
    declare export type QueryObserverSuccessResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...QueryObserverBaseResult<TData, TError>,
    ...
    declare export type InfiniteQueryObserverBaseResult<
        TData = mixed,
        TError = mixed
    > = {|
    ...
    declare export type InfiniteQueryObserverIdleResult<
        TData = mixed,
        TError = mixed
    > = {|
    ...
    declare export type InfiniteQueryObserverLoadingResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...InfiniteQueryObserverBaseResult<TData, TError>,
    ...
    declare export type InfiniteQueryObserverLoadingErrorResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...InfiniteQueryObserverBaseResult<TData, TError>,
    ...
    declare export type InfiniteQueryObserverRefetchErrorResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...InfiniteQueryObserverBaseResult<TData, TError>,
    ...
    declare export type InfiniteQueryObserverSuccessResult<
        TData = mixed,
        TError = mixed
    > = {|
        ...InfiniteQueryObserverBaseResult<TData, TError>,
    ...
    declare export type InfiniteQueryObserverResult<
        TData = mixed,
        TError = mixed
    > =
    ...
    declare export type QueriesObserverListener<TData = mixed, TError = mixed> =
        (result: $ReadOnlyArray<QueryObserverResult<TData, TError>>) => void
    ...
    declare export type InfiniteQueryObserverListener<
        TData = mixed,
        TError = mixed
    ...
    declare export type MutateOptions<
        TData = mixed,
        TError = mixed,
        TVariables = mixed,
        TContext = mixed
    ...
    declare export type MutateFunction<
        TData = mixed,
        TError = mixed,
        TVariables = mixed,
        TContext = mixed
    ...
    |}
    declare export type MutationState<
        TData = mixed,
        TError = mixed,
        TVariables = mixed,
        TContext = mixed
    ...
    declare export type MutationAction<
        TData = mixed,
        TError = mixed,
        TVariables = mixed,
        TContext = mixed
    ...
    declare export type UseBaseQueryResult<TData = mixed, TError = mixed> =
        QueryObserverResult<TData, TError>

    declare export type UseQueryResult<TData = mixed, TError = mixed> =
        UseBaseQueryResult<TData, TError>

    declare export type UseInfiniteQueryResult<TData, TError> =
    ...
    declare export type UseMutateFunction<
        TData = mixed,
        TError = mixed,
        TVariables = mixed,
        TContext = mixed
    ...
    declare export function useQuery<
        TQueryFnData = mixed,
        TError = mixed,
        TData = TQueryFnData
    >(
    ...
    declare export function useQueries<
        TQueryFnData = mixed,
        TError = mixed,
        TData = TQueryFnData
    >(
